    ...
    <section id="testimonials" className="relative py-20 md:py-32">
      ...
      <div className="container relative px-4 md:px-8">
        <div className="mx-auto max-w-2xl text-center">
          <h2 className="mb-4 text-3xl font-bold tracking-tight md:text-4xl text-[#1f2937]">What Our Customers Say</h2>
          <p className="mb-16 text-lg text-[#d8dadf]">
        ...
        <div className="grid gap-8 md:grid-cols-3">
          {testimonials.map((testimonial, index) => (
            <div
              key={index}
              className="flex flex-col rounded-xl border border-[#e5e7eb] bg-[#f2efe5] p-6 backdrop-blur-sm"
            >
              <svg className="mb-4 h-8 w-8 text-[#4f46e5]" fill="currentColor" viewBox="0 0 24 24">
                <path d="M14.017 21v-7.391c0-5.704 3.731-9.57 8.983-10.609l.995 2.151c-2.432.917-3.995 3.638-3.995 5.849h4v10h-9.983zm-14.017 0v-7.391c0-5.704 3.748-9.57 9-10.609l.996 2.151c-2.433.917-3.996 3.638-3.996 5.849h3.983v10h-9.983z" />
              </svg>
              <p className="mb-6 flex-1 text-[#6b7280]">{testimonial.quote}</p>
              <div className="flex items-center">
                ...
                />
                <div>
                  <p className="font-bold text-[#1f2937]">{testimonial.author}</p>
